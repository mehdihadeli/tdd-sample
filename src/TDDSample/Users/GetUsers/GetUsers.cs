...
public record GetUsers
	(PageRequest PageRequest) : IRequest<OneOf<PagedList<UserDto>, HttpResponseException, InternalServerException>>;

internal class GetUsersHandler : IRequestHandler<GetUsers,
	OneOf<PagedList<UserDto>, HttpResponseException, InternalServerException>>
{
